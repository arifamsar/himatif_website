...
const Home = () => {
  ...
  const listcoreteams = coreteams.map((coreteams) => {
    return (
      <div key={coreteams.id} className="bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="p-6">
  ...
  const listdivisions = divisions.map((divisions) => {
    return (
      <div key={divisions.id} className="bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="p-6">
  ...
  return (
    <>
      ...
      <div className="h-max max-w-full bg-blue-gray-50 py-10">
        <div className="container mx-auto lg:px-36 px-5">
          <div className="py-12">
            <h2 className="text-2xl font-bold text-primary">Pengurus Himatif</h2>
            <p className="text-blue-gray-500">Pengurus inti dari himatif</p>
